...
///Hotscreen displaying postcards
class SarakelHotScreen extends StatefulWidget {
  final HomescreenController homescreenController;

  const SarakelHotScreen({required this.homescreenController, super.key});

  @override
  State<SarakelHotScreen> createState() => _SarakelHotScreenState();
}

class _SarakelHotScreenState extends State<SarakelHotScreen> {
    ...
    return Scaffold(
      ...
      body: postsToShow == null
          ...
          : CustomMaterialIndicator(
              onRefresh: () async {
                final posts = await widget.homescreenController.loadHotPosts();
                setState(() => postsToShow = posts);
              },
